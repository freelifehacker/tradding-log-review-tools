...
router.get('/pdf', (req,res) => {
  var fileName = _rootPath+'/static/data/pdf/1001100100141193-20180726.pdf';
  exec('pdftohtml -opw '+_config.pdf_password+' -p -noframes '+fileName, {encoding: 'utf-8'}, function(err, stdout, stderr) {
    if (err) {
